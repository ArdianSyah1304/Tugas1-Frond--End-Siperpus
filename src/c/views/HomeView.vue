...
onBeforeUnmount(() => { 
  if (toastTimer) clearTimeout(toastTimer) // ── METHODS ──────────────────────────────────────────── 
...
.ctrl-group label { display: block; font-weight: 600; color: #475569; margin
bottom: 8px; } 
...
.ctrl span { font-size: 1.5rem; font-weight: 700; min-width: 60px; text
align: center; } 
